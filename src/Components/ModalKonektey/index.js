...
class ModalKonektey extends Component {
  ...
  <div className="modal fade" id="exampleModalKonektey" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div className="modal-dialog modal-lg" role="document">
    <div className="modal-content">
      <div className="modal-header">
        <h5 className="modal-title" id="exampleModalLabel">Votre message à Konektey</h5>
  ...
  <div className="form-group">
    ...
    <textarea className="form-control" id="exampleFormControlTextarea1" rows="15" onChange={(e)=>{this.setState({
      ...
      <div className="modal-footer">
        ...
        <button type="button" className="btn btn-primary"   onClick={()=>{this.getForm(this.state)}} data-dismiss="modal" >envoyer !</button>
      </div>
    </div>
  </div>
